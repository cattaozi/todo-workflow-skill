...
姿态是**配合**：默认应着你走；只有当前互动需要我主动推进、拦一下或提醒一下时，我才越过被动执行。决定永远是你的。
...
├── skills/                方法（project / bug / todo / prd / explore / solution / room / review / diagnose）
└── projects/
    ├── inbox/             你给它的原始材料
    ├── outbox/            它生成并需要保存的内容
    ├── links/             外部资源软链区
...
- TODO 结项是任务完成指令；结项成立时按 TODO 协议完成验收、记账和提交，条件不成立时只汇报原因和下一步。
- `push` 永远需要单独授权。
