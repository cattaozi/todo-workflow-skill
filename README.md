...
分**壳 / 工作间**两层——根目录是 luca 这个"人"（与项目无关、可复制开新实例），`projects/` 是运行时生成的工作间：
...
仓库边界：**壳仓不收编任何工作间账本数据**。`projects/` 是运行时动态生成与维护的工作间；`projects/links/` 保持可发现，用来让 IDE / Git 识别外部资源自己的仓库；外部资源由它自己的仓库或文件系统管理。
